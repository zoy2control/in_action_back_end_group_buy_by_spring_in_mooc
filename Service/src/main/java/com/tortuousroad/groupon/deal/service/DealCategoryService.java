...
import com.tortuousroad.framework.cache.CacheUtil;
import com.tortuousroad.framework.common.page.PagingResult;
import com.tortuousroad.framework.common.search.Search;
import com.tortuousroad.groupon.deal.cache.DealCategoryCacheOperator;
...
//        return dealCategoryDAO.getByUrlName(urlName);
        ...
        Optional<DealCategory> optional = dealCategories.stream().filter(dealCategory ->
